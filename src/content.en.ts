		...
		categories: [
			...
			},
			{
				...
				description: [
					...
					'Notes',
					'● All poster submissions use **double-blind review**. Please upload an anonymized PDF file. If the submission is not anonymized, it will be directly rejected. The PDF including attachments must be under 20MB. Please optimize the file in Acrobat while keeping the content clearly legible on screen.',
