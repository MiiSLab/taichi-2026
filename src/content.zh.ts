			...
			day1: {
				...
				poster: {
					...
					items: [
						...
						{ id: '123', title: 'Douleur Minime: Material Speculation of the AI Between Us', authors: 'Sheng-Wen Chen and Chia-Ni Chen' },
			...
			day2: {
				...
				poster: {
					...
					items: [
						...
						{ id: '15', title: '翻閱我的一天：以小說化轉譯與漸進傳送機制之反思行事曆', authors: '子文 蔡 and 容輝 梁' },
						...
						{ id: '124', title: 'OmniObserve: Revealing Hidden Consensus in Online Meetings', authors: 'Sky Shih-Kai Hong, Ethel Yu-Tsen Hsiao, Yi-Jie Chen, Jason Zhi-Jun Chang, Elvis Dragon Mao and Grace Yu-Chun Yen' },
						{ id: '111', title: '設計師如何想像未來？未來場域生成器：以生成式 AI 輔助未來情境建構', authors: 'Chih-Yu Wei and Rung-Huei Liang' },
						{ id: '70', title: 'Breathsync: Exploring Emotion-Embedded AIoT Companions for Futuristic Domestic Care', authors: 'Yin-Chi Lien, Ya-Ching Chang, Yun-Chen Lin, Yueh-Yin Kuo, Ze-Kai Lee and Yaliang Chuang' },
						{ id: '61', title: '不是問 AI，是問那些人：以虛構他者獨白引發自我反思', authors: '律姍 林 and 容輝 梁' },
						...
						{ id: '125', title: 'Designing AI-Empowered Infrastructure for the Voiceless: Empowering Frontline Inspectors in Animal Protection Enforcement', authors: 'Kun Hung Tsai, Che Han Hsieh, Yu Ting Tseng and Neng Hao Yu' },
						{ id: '127', title: 'Supporting Perspective-Taking in Parent-Child Conflict Through AI Context Scaffolding', authors: 'Kuan-Yu Lin and Yu-Ni Tseng' },
						{ id: '17', title: '聽見內在的複數自我：基於內在家庭系統理論之多代理人焦慮緩解初探', authors: '妮瑾 李 and 容輝 梁' },
						{ id: '22', title: '以 AI 聊天機器人促進大學新生心理適應之研究：以「NOVUS」App 開發與評估為例', authors: 'Chieh Ju Huang, 昱錡 陳, 幸佑 陳 and 喬茵 莊' },
						{ id: '44', title: 'Poster: SyntAIx–為華語兒童複雜句式初學者設計之AI人機協作與鷹架輔助系統', authors: '周子傑, 陳定均, 梁思遠, and 程芙茵' },
						{ id: '35', title: '旅遊情境中智慧眼鏡搭載GAI語音助理之敘事互動框架設計', authors: '逸青 施, 蕾 許 and 桂嘉 梁' },
						{ id: '21', title: 'Drive Me Crazy：基於AI的分心駕駛認知覺察互動遊戲之實證研究', authors: 'Chieh Ju Huang, 昱錡 陳, 聖宏 蕭, 承宇 康, 耘晧 曾, 晉維 周 and 凱琳 黃' },
						...
						{ id: '69', title: 'Learning Together in the Witch’s House: Asymmetric Parent–Child Collaboration for Collocation Learning in VR', authors: 'Chu Chi Chang and Neng Hao Yu' },
						{ id: '88', title: 'Poster:意圖立場對360度遊戲化導覽中視覺搜尋的由上而下注意力引導－以陽明交通大學博愛校區為例', authors: 'Cai Yu Gao, Zih Jyun Lin and Yen Fang Lee' },
						{ id: '60', title: 'NOVARA-X: A Self-Watering Vase and Context-Aware Companion System', authors: '李浚瑋 (Chun-Wei Lee), 葉書芸 (Shu-Yun Yeh), 莊雅量 (Yaliang Chuang)' },
						{ id: '7', title: '當多感官互動遇上文學轉譯體驗，以楊千鶴〈花開時節〉為例', authors: '萱雅 李' },
