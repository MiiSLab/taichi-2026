			...
			day1: {
				...
				poster: {
					...
					items: [
						...
						{ id: '45', title: 'The Effect of Evaluative Context on Self-Presentation in Human-AI Interaction', authors: 'Tsai-Ni Chen and Yi-Hsiu Chen' },
			...
			day2: {
				...
				poster: {
					...
					items: [
						...
						{ id: '15', title: '翻閱我的一天：以小說化轉譯與漸進傳送機制之反思行事曆', authors: '蔡子文, 梁容輝' },
						{ id: '39', title: '社群收藏行為探究', authors: 'Mong-Ru Lin, Yen-En Chiang, Li-Shiang Chiang and Yu-Hsuan Chu' },
						{ id: '50', title: 'Believe It or Not? @Threads使用者轉發「好運貼文」的動機初探', authors: 'Yin-Chen Yang, Ting-Chen Lu, Ching Ling Lee and Ho-Lin Peng' },
						...
						{ id: '124', title: 'OmniObserve: Revealing Hidden Consensus in Online Meetings', authors: 'Shih-Kai Hong, Ethel Yu-Tsen Hsiao, Yi-Jie Chen, Jason Zhi-Jun Chang, Elvis Dragon Mao and Grace Yu-Chun Yen' },
						{ id: '111', title: '設計師如何想像未來？未來場域生成器：以生成式 AI 輔助未來情境建構', authors: '魏芷榆, 梁容輝' },
						...
						{ id: '61', title: '不是問 AI，是問那些人：以虛構他者獨白引發自我反思', authors: '林律姍, 梁容輝' },
						{ id: '76', title: '從互動風格到追問取向：9-12歲兒童 AI 學習夥伴設計的形成性焦點團體研究', authors: '呂東易, 余佳穎' },
						{ id: '37', title: 'AI 腔與人機寫作互動：生成式 AI 使用者的語感校準經驗研究', authors: '葉潔' },
						...
						{ id: '17', title: '聽見內在的複數自我：基於內在家庭系統理論之多代理人焦慮緩解初探', authors: '李妮瑾, 梁容輝' },
						{ id: '22', title: '以 AI 聊天機器人促進大學新生心理適應之研究：以「NOVUS」App 開發與評估為例', authors: 'Chieh Ju Huang, 陳昱錡, 陳幸佑, 莊喬茵' },
						{ id: '44', title: 'Poster: SyntAIx–為華語兒童複雜句式初學者設計之AI人機協作與鷹架輔助系統', authors: '周子傑, 陳定均, 梁思遠, 程芙茵' },
						{ id: '35', title: '旅遊情境中智慧眼鏡搭載GAI語音助理之敘事互動框架設計', authors: '施逸青, 許蕾, 梁桂嘉' },
						{ id: '21', title: 'Drive Me Crazy：基於AI的分心駕駛認知覺察互動遊戲之實證研究', authors: '黃絜如, 陳昱錡, 蕭聖宏, 康承宇, 曾耘晧, 周晉維, 黃凱琳' },
						...
						{ id: '88', title: 'Poster:意圖立場對360度遊戲化導覽中視覺搜尋的由上而下注意力引導－以陽明交通大學博愛校區為例', authors: '高采瑜, 林姿均, 李姸昉' },
						...
						{ id: '7', title: '當多感官互動遇上文學轉譯體驗，以楊千鶴〈花開時節〉為例', authors: '李萱雅' },
