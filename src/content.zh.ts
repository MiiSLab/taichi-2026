		...
		programLists: {
			...
			day1: {
				...
				poster: {
					...
					items: [
						...
						{ id: '16', title: 'Poster: Hyndreste: An Aiming-Based Mixed Reality Interface for Externalizing Hidden Emotions', authors: 'Chu Yang Tsai, Jia Yi Chen, Yi Ling Chao, Pei Ling Chang and Yi Chun Ko' },
						...
						{ id: '109', title: 'Poster: Training Animal Crime Scene Investigators through Physical Interaction and AI-Driven Situational Pressure', authors: 'Yuting Tseng and Neng Hao Yu' },
						...
						{ id: '10', title: 'What Makes an Initial Reaction Ready for Discussion?: Multi-Persona AI Support for Stance Reflection and Writing', authors: 'Sky Shih-Kai Hong, Mu-Tien Kuo, Wei-Ji Chen and Dennis Wang' },
						{ id: '49', title: 'From Anxiety to Execution: Supporting Perceived Control to Mitigate Procrastination through AI Task Decomposition', authors: 'Yuan Yuan Shih, Wan Tian Wu and Ke Yu Wu' },
						{ id: '45', title: 'The Effect of Evaluative Context on Self-Presentation in Human-AI Interaction', authors: 'Tsai Ni Chen' },
						{ id: '81', title: 'From Brand Values to Conversational Style: A Design Framework for LLM-Based Customer Service Agents', authors: 'Ming-Ru Lu and Yu-Ting Cheng' },
						{ id: '51', title: 'From meal to memory: Preserving Taiwanese Culinary Heritage through Social Robots and Generative AI', authors: 'Ting-Chen Lu, Chiau-Le Lio, Yu-Tong Li, Hung-Chun Chang, Jui-Ying Wang and Hsiu-Ping Yueh' },
						{ id: '123', title: 'Douleur Minime: Material Speculation of the AI Between Us', authors: 'Sam Chen and Chia-Ni Chen' },
						{ id: '19', title: 'Transforming Personal Attack Comments into Memes on Social Media: A Preliminary Exploratory Study', authors: 'Hui-Han Dee, Chia-Yun Chen, Knas Xiao, Yu-Chun Yen and Yung-Ju Chang' },
						{ id: '89', title: "Shared but Untraceable: The Emotional and Behavioral Impacts of Private Post Forwarding on Users' Self-Disclosure", authors: 'Ting Chen Su, Yu Hsuan Yen, Ke Chieh Teng and Zhu Yuan Lai' },
						...
						{ id: '67', title: 'Poster: Experience Design for Long-Term Commitment in Pet Care: Bridging Pre-Acquisition Evaluation and Companion Support', authors: 'Che Han Hsieh and Neng Hao Yu' },
			...
			day2: {
					...
					groups: [
						...
						},
						{
							...
							items: [
								...
								{ id: '9', title: '虛擬實境投擲系統之設計與實作', authors: 'Mu-Yun Tseng, Jun-Fu Lin-Lu, Jia-Xiang Zhang and Yi-Jheng Huang' },
								{ id: '82', title: 'Support Remote Tutoring in Programming Education utilizing Mixed Reality and LLM-based AI Tutors', authors: 'Tzu-Hsiang Huang, Hung-Yi Chen, Van Tan Sang Pham, Thanh Thao Ly Nguyen, Khanh-Duy Le and Fu-Yin Cherng' },
							],
						},
						{
				...
				poster: {
					...
					items: [
						{ id: '106', title: "Taiwan CHI 始/史？: A Registered Research on Understanding the Flourish of Taiwan's HCI Community", authors: 'Yang Chen Lin, I-Chen Lo and Cai-Ling Wang' },
						{ id: '15', title: '翻閱我的一天：以小說化轉譯與漸進傳送機制之反思行事曆', authors: '子文 蔡, 容輝 梁' },
						{ id: '39', title: '社群收藏行為探究', authors: 'Mong-Ru Lin, Yen-En Chiang, Li-Shiang Chiang and Yu-Hsuan Chu' },
						{ id: '50', title: 'Believe It or Not? @Threads使用者轉發「好運貼文」的動機初探', authors: 'Yin-Chen Yang, Ting Chen Lu, Ho-Lin Peng and Ching Ling Lee' },
						{ id: '32', title: '從使用者洞察到實驗驗證：以易用性測試的洞察為基礎的設計，探討初始引導對陪伴型聊天機器人信任影響之實驗研究——以 NYCUKA 為案例', authors: 'Ya Ting Chang, Chen-Shi Liu and Jou-Chia Tseng' },
						{ id: '102', title: 'ThreadMark: A Personal Knowledge Curation Tool for Crowd-Sourced Information from Threads', authors: 'Yu-Yen Chang, Tzu-Yang Chiu, Yang Chen Lin, Cai-Ling Wang and Chuang-Wen You' },
						{ id: '111', title: '設計師如何想像未來？未來場域生成器：以生成式 AI 輔助未來情境建構', authors: 'Chih-Yu Wei and Rung-Huei Liang' },
						...
						{ id: '44', title: 'Poster: SyntAIx–為華語兒童複雜句式初學者設計之AI人機協作與鷹架輔助系統', authors: 'Jason Chou, Benny Chen, Shih-Yuan Liang and Fuyin Cherng' },
						...
						{ id: '107', title: 'TimeCare: A Night-Time Outgoing Call Interception and Voice Intervention System', authors: 'I-Chun Chen and Yong-Xiang Chen' },
						{ id: '69', title: "Poster: Learning Together in the Witch's House: Asymmetric Parent–Child Collaboration for Collocation Learning in VR", authors: 'Chu Chi Chang and Neng Hao Yu' },
						{ id: '88', title: 'Poster:意圖立場對360度遊戲化導覽中視覺搜尋的由上而下注意力引導－以陽明交通大學博愛校區為例', authors: 'Cai Yu Gao, Zih Jyun Lin and Yen Fang Lee' },
						{ id: '60', title: 'NOVARA-X: A Self-Watering Vase and Context-Aware Companion System', authors: 'Chun-Wei Lee and Shu-Yun Yeh' },
						...
						{ id: '56', title: 'Contextual Gazer: Facilitating Stranger Interaction through Eye Tracking, Facial Reactions, and Shared Contexts', authors: 'Po-Hsun Chen, Cheng-Wen Huang and Yi-Chen Shen' },
