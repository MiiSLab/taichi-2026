...
export const CONTENT_ZH = {
	...
	programPageSection: {
		...
		// 發表名單：依發表時段掛在對應日 tab 的時程表下方（day1=08/05 三創、day2=08/06 北科）。
		// 名單為專有名詞，en 版直接引用本資料、只覆寫標籤與 slot（見 content.en.ts）。
		programLists: {
			labels: {
				sectionTitle: '發表名單',
				idCol: '編號',
			...
			day1: {
				demo: {
					...
					items: [
						{ id: '23', title: 'Demo: Fragmented Sunshine of the Spotless Mind', authors: 'An-Che Liang, Rung-Huei Liang' },
						{ id: '47', title: 'Poster & Demo: Prototype It, Prompt It, Play It: Crafting Functional Tactile Interactions in 10 Minutes', authors: 'Meichun Liu, Devin Francis Murphy, Yiyue Luo' },
						{ id: '53', title: 'Poster & Demo: Wind Tide Box: An Atmospheric Instrument for Public Embodied Music Interaction', authors: 'Yi Chun Ko, Chueh-Fu Yu, Bo-Yu Tseng' },
						{ id: '78', title: 'Demo: Beyond Instantaneous Toggling: Designing Audiovisual Feedback for Superpower Transitions in Virtual Reality', authors: 'I-Chin Chen, Lei Hong, Chun-Cheng Hsu' },
						{ id: '86', title: 'Poster & Demo: NOVARA-X: A Self-Watering Vase and Context-Aware Companion System', authors: 'Chun-Wei Lee, Shu-Yun Yeh' },
						{ id: '96', title: 'Demo: Divine Arrow — Encountered-Type Real Bow with Magnetic Draw Sensing for Elemental VR Archery', authors: 'Chia-Min Chuang, Cheng-Ning Wang, Yu-Chieh Lu, Hsuan-Chung Chen, Yu-Jie Lin, Qiao-Xi Xu, Yin-Tung Yeh, Tse-Yu Pan, Neng-Hao Yu' },
						{ id: '104', title: 'Poster & Demo: Douleur Minime: Material Speculation of the AI Between Us', authors: 'Sheng-Wen Chen, Chia-Ni Chen' },
						{ id: '116', title: 'Poster & Demo: Sleep Airline: Reframing Sleep Duration as Flight Narratives', authors: 'Tzu Yen Hsu, Yu-Ting Cheng' },
						{ id: 'OpenHCI', title: 'Soulsee 熟悉', authors: 'Shang-Yuan Chang, Chin-Ling Chang, Pei-Jung Yang, Yi-An Lu, Yi-Jie Chen, Xin-Yu Huang, Chi-En Chung' },
						{ id: 'OpenHCI', title: 'Whose Inner Voice', authors: 'Yan-Ting Li, Shiau-Lin Lin, Han-Po Chen, Chun-Hao Tu, Chen-Shi Liu, Yan-Zhen Chen' },
					],
				},
				poster: {
					heading: 'Poster',
					slot: '08/05 · 三創互動夜市（12F 多元廳）',
					items: [
						{ id: '13', title: 'Tactile Musical Track: A Wearable for Blind Musicians to Feel Preemptive Cues During Performance', authors: 'Jung-Sheng Hung, Ting-Chen Lu, Yen-Chang Chen, Shan-Yuan Teng' },
						{ id: '71', title: 'Wind Tide Box: An Atmospheric Instrument for Public Embodied Music Interaction', authors: 'Yi Chun Ko, Chueh-Fu Yu, Bo-Yu Tseng' },
						{ id: '16', title: 'Poster: Hyndreste: An Aiming-Based Mixed Reality Interface for Externalizing Hidden Emotions', authors: 'Chu Yang Tsai, Jia Yi Chen, Yi Ling Chao, Pei Ling Chang, Yi Chun Ko' },
						{ id: '33', title: 'Exploring the Stroop Effect of Object-Color Association', authors: 'Chu-Yun Chen' },
						{ id: '29', title: 'Emoji Sonification for Inclusive Texting: The Effect of Vocal Bursts and Prosodic Voices on Ambiguous Messages', authors: 'Sophia Greiwe, Shan-Yuan Teng' },
						{ id: '109', title: 'Poster: Training Animal Crime Scene Investigators through Physical Interaction and AI-Driven Situational Pressure', authors: 'Yuting Tseng, Neng Hao Yu' },
						{ id: '58', title: 'PRIMA - Enabling User Agency and Control in Mobile GUI Agent Autonomy', authors: 'Ching-Ting Lin, Zhi-Hong Yen, Ya-Jen Cheng, Yung-Ju Chang' },
						{ id: '91', title: 'Clear Yet Insufficient: Why Users Still Return to Source Notifications After Task Extraction', authors: 'Uei-Dar Chen, Rui-Jie Huang, Yu-Shiun Wu, Yi-Chia Wang, Yung-Ju Chang' },
						{ id: '90', title: '生成式 AI 聊天介面微互動設計對易用性之研究', authors: '妤欣 蔡' },
						{ id: '10', title: 'What Makes an Initial Reaction Ready for Discussion?: Multi-Persona AI Support for Stance Reflection and Writing', authors: 'Sky Shih-Kai Hong, Mu-Tien Kuo, Wei-Ji Chen, Dennis Wang' },
						{ id: '49', title: 'From Anxiety to Execution: Supporting Perceived Control to Mitigate Procrastination through AI Task Decomposition', authors: 'Yuan Yuan Shih, Wan Tian Wu, Ke Yu Wu' },
						{ id: '45', title: 'The Effect of Evaluative Context on Self-Presentation in Human-AI Interaction', authors: 'Tsai Ni Chen' },
						{ id: '81', title: 'From Brand Values to Conversational Style: A Design Framework for LLM-Based Customer Service Agents', authors: 'Ming-Ru Lu, Yu-Ting Cheng' },
						{ id: '51', title: 'From meal to memory: Preserving Taiwanese Culinary Heritage through Social Robots and Generative AI', authors: 'Ting-Chen Lu, Chiau-Le Lio, Yu-Tong Li, Hung-Chun Chang, Jui-Ying Wang, Hsiu-Ping Yueh' },
						{ id: '123', title: 'Douleur Minime: Material Speculation of the AI Between Us', authors: 'Sam Chen, Chia-Ni Chen' },
						{ id: '19', title: 'Transforming Personal Attack Comments into Memes on Social Media: A Preliminary Exploratory Study', authors: 'Hui-Han Dee, Chia-Yun Chen, Knas Xiao, Yu-Chun Yen, Yung-Ju Chang' },
						{ id: '89', title: "Shared but Untraceable: The Emotional and Behavioral Impacts of Private Post Forwarding on Users' Self-Disclosure", authors: 'Ting Chen Su, Yu Hsuan Yen, Ke Chieh Teng, Zhu Yuan Lai' },
						{ id: '74', title: 'A Theory-Informed UX Redesign for A Mobile Vocabulary Learning Application', authors: 'Yu-Ting Huang, Li-Min Huang' },
						{ id: '67', title: 'Poster: Experience Design for Long-Term Commitment in Pet Care: Bridging Pre-Acquisition Evaluation and Companion Support', authors: 'Che Han Hsieh, Neng Hao Yu' },
						{ id: '14', title: 'Sleep Airline: Reframing Sleep Duration as Flight Narratives', authors: 'Tzu Yen Hsu, Yu-Ting Cheng' },
					],
				},
			},
			day2: {
					...
					groups: [
						{
							...
							items: [
								...
								{ id: '41', title: 'ReBridge: Designing for AI-Supported Attention Resumption after Distraction', authors: 'Ting-Yi Chen, Ting-Yu Tseng, Chien-Fang Lee, Yuan-Chi Tseng' },
						...
						},
						{
							...
							time: '10:00 - 10:50',
							items: [
								{ id: '48', title: 'Evaluating the Effect of Overconfidence-Based Interventions in Intelligent Anti-Fraud Systems using Behavioral and Cognitive Metrics', authors: 'Bo-Cun Li, Ci-Chen Lin, Fu-Yin Cherng' },
								{ id: '68', title: '從訊息可信到責任歸因：AI 整合型態與購買機制在社群商務的作用機制', authors: '李圯瀞, 劉劭禹, 程安如, 畢南怡, 陳炳宇' },
								{ id: '75', title: '情感捷思跟涉入程度對於 AI 代理人信任之影響', authors: 'Yi Ting Li, Yi Hsiu Chen' },
								{ id: '73', title: 'From Human Love to Artificial Intimacy: How Humans Transfer and Adapt Conflict Resolution Styles to AI Romantic Partners', authors: 'Chia-Hui Shih, Yoyo Tsung-Yu Hou' },
							],
						},
						{
							...
							items: [
								...
								{ time: '11:40 - 11:50', title: '透過可追溯的提示詞提升場景設計中圖像編輯的可控性', authors: '李婷穎', award: '碩士最佳論文獎' },
								{ time: '11:50 - 12:00', title: '透過視線驅動之虛擬化身改善跨裝置沈浸式虛擬會議使用者間的表達落差', authors: '黃晴、施孟廷', award: '碩士佳作論文獎' },
							],
						},
						{
							...
							time: '13:30 - 14:20',
							items: [
								{ id: '30', title: '當震動不只是通知：對話式 AI 中手機觸覺回應的互動設計', authors: 'Yuehyin Kuo, Hsin Lin, Chuncheng Hsu' },
								{ id: '57', title: '在延展實境透過穿戴式模組化鏈狀動態被動觸覺回饋裝置呈現手部形狀回饋', authors: '胡乃云, 林昱安, 羅聿安, 蔡欣叡' },
								{ id: '9', title: '虛擬實境投擲系統之設計與實作', authors: 'Mu-Yun Tseng, Jun-Fu Lin-Lu, Jia-Xiang Zhang, Yi-Jheng Huang' },
								{ id: '82', title: 'Support Remote Tutoring in Programming Education utilizing Mixed Reality and LLM-based AI Tutors', authors: 'Tzu-Hsiang Huang, Hung-Yi Chen, Van Tan Sang Pham, Thanh Thao Ly Nguyen, Khanh-Duy Le, Fu-Yin Cherng' },
							],
						},
						{
							...
							time: '14:30 - 15:20',
							items: [
								{ id: '95', title: 'When Our Sofa Speaks: Mediating Care Through Collective Data Making Between Family Members and a Domestic Object', authors: 'En-Kai Chang, Yi-Tong Chen, Yu-Ting Cheng' },
								{ id: '36', title: '24.8小時：病房中的植物性互動設計', authors: 'Ruo-Yu Cai, Xuan Chen, I-Hao Liao' },
								{ id: '98', title: 'PlantShelter: A Design Fiction Concept for Preserving Endangered Plant Species for the Future', authors: 'Yaliang Chuang, Hsuen-Wei Chang, Peiying Lin' },
								{ id: '115', title: 'Chronotree：日常環境色彩反思的實體化設計', authors: 'Yu-Wei Yang, Wenn-Chieh Tsai' },
							],
						},
					],
				},
				poster: {
					heading: 'Poster',
					slot: '08/06 · Poster Session（Coffee Break 10:50–11:10 / 15:20–15:40）',
					items: [
						{ id: '106', title: "Taiwan CHI 始/史？: A Registered Research on Understanding the Flourish of Taiwan's HCI Community", authors: 'Yang Chen Lin, I-Chen Lo, Cai-Ling Wang' },
						{ id: '15', title: '翻閱我的一天：以小說化轉譯與漸進傳送機制之反思行事曆', authors: '子文 蔡, 容輝 梁' },
						{ id: '39', title: '社群收藏行為探究', authors: 'Mong-Ru Lin, Yen-En Chiang, Li-Shiang Chiang, Yu-Hsuan Chu' },
						{ id: '50', title: 'Believe It or Not? @Threads使用者轉發「好運貼文」的動機初探', authors: 'Yin-Chen Yang, Ting Chen Lu, Ho-Lin Peng, Ching Ling Lee' },
						{ id: '32', title: '從使用者洞察到實驗驗證：以易用性測試的洞察為基礎的設計，探討初始引導對陪伴型聊天機器人信任影響之實驗研究——以 NYCUKA 為案例', authors: 'Ya Ting Chang, Chen-Shi Liu, Jou-Chia Tseng' },
						{ id: '102', title: 'ThreadMark: A Personal Knowledge Curation Tool for Crowd-Sourced Information from Threads', authors: 'Yu-Yen Chang, Tzu-Yang Chiu, Yang Chen Lin, Cai-Ling Wang, Chuang-Wen You' },
						{ id: '111', title: '設計師如何想像未來？未來場域生成器：以生成式 AI 輔助未來情境建構', authors: 'Chih-Yu Wei, Rung-Huei Liang' },
						{ id: '70', title: 'Breathsync: Exploring Emotion-Embedded AIoT Companions for Futuristic Domestic Care', authors: 'Yin-Chi Lien' },
						{ id: '61', title: '不是問 AI，是問那些人：以虛構他者獨白引發自我反思', authors: '律姍 林, 容輝 梁' },
						{ id: '76', title: '從互動風格到追問取向：9-12歲兒童 AI 學習夥伴設計的形成性焦點團體研究', authors: 'Tung Yi Lu' },
						{ id: '37', title: 'AI 腔與人機寫作互動：生成式 AI 使用者的語感校準經驗研究', authors: '潔 葉' },
						{ id: '17', title: '聽見內在的複數自我：基於內在家庭系統理論之多代理人焦慮緩解初探', authors: '妮瑾 李, 容輝 梁' },
						{ id: '22', title: '以 AI 聊天機器人促進大學新生心理適應之研究：以「NOVUS」App 開發與評估為例', authors: 'Chieh Ju Huang, 昱錡 陳, 幸佑 陳, 喬茵 莊' },
						{ id: '44', title: 'Poster: SyntAIx–為華語兒童複雜句式初學者設計之AI人機協作與鷹架輔助系統', authors: 'Jason Chou, Benny Chen, Shih-Yuan Liang, Fuyin Cherng' },
						{ id: '35', title: '旅遊情境中智慧眼鏡搭載GAI語音助理之敘事互動框架設計', authors: '逸青 施, 蕾 許, 桂嘉 梁' },
						{ id: '21', title: 'Drive Me Crazy：基於AI的分心駕駛認知覺察互動遊戲之實證研究', authors: 'Chieh Ju Huang, 昱錡 陳, 聖宏 蕭, 承宇 康, 耘晧 曾, 晉維 周, 凱琳 黃' },
						{ id: '107', title: 'TimeCare: A Night-Time Outgoing Call Interception and Voice Intervention System', authors: 'I-Chun Chen, Yong-Xiang Chen' },
						{ id: '69', title: "Poster: Learning Together in the Witch's House: Asymmetric Parent–Child Collaboration for Collocation Learning in VR", authors: 'Chu Chi Chang, Neng Hao Yu' },
						{ id: '88', title: 'Poster:意圖立場對360度遊戲化導覽中視覺搜尋的由上而下注意力引導－以陽明交通大學博愛校區為例', authors: 'Cai Yu Gao, Zih Jyun Lin, Yen Fang Lee' },
						{ id: '60', title: 'NOVARA-X: A Self-Watering Vase and Context-Aware Companion System', authors: 'Chun-Wei Lee, Shu-Yun Yeh' },
						{ id: '7', title: 'Poster & Demo: 當多感官互動遇上文學轉譯體驗，以楊千鶴〈花開時節〉為例', authors: '萱雅 李' },
						{ id: '112', title: '多模態情緒感知線上議價助理系統之應用', authors: '萱恩 陳, Yong-Xiang Chen' },
						{ id: '56', title: 'Contextual Gazer: Facilitating Stranger Interaction through Eye Tracking, Facial Reactions, and Shared Contexts', authors: 'Po-Hsun Chen, Cheng-Wen Huang, Yi-Chen Shen' },
						{ id: '101', title: '結合手機握力互動與磁流體回饋之日常肌力訓練系統', authors: '侑恩 謝, 絮喬 汪, 心慈 謝, Yong-Xiang Chen' },
						{ id: '26', title: 'Mixed Reality Teleoperation Pipeline for Resource-Constrained Mini-car via ROS2 Server', authors: 'Wei-Ting Chou, Chen-Chung Pan, Hung-Jui Guo' },
					],
				},
			},
		},
